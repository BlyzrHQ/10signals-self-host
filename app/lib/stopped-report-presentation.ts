...
export function stoppedReportPresentation(errorMessage: string | null | undefined, errorCode: string | null | undefined, ar: boolean): StoppedReportPresentation {
  ...
  if (refusedHomepage) return ar ? {
    ...
    summary: "The website returned HTTP 403 when 10Signals requested its public homepage, so no market comparison was created. This is an access restriction, not proof that the website or business is unavailable.",
  };
